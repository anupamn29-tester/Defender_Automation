...
public class OrgAssociateOrganizations extends BaseClassSetup{
...
//	private By inputsearch=By.xpath("//kendo-textbox[@placeholder=\"Search in selected column...\"]/input");
	...
	public OrgAssociateOrganizations() {
		PageFactory.initElements(driver, this);
	}
	
	public void OrgAssociateOrganizationslocators() throws InterruptedException, IOException {
...
//	  	searchinput.sendKeys("Abdullah Azzam Brigades-Personnel");
		...
		//End here
	  	...
	  	editinput.click();
	  	eve.kendotabstriptab("Associate Organizations");
